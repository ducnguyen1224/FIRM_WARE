...
#CXXFLAGS	= -Os -g -O2 -Wpointer-arith -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals #-mno-serialize-volatile -D__ets__ -DICACHE_FLASH -fno-rtti -fno-exceptions -std=c++11
...
#-DCOM_SPEED_SERIAL=$(COM_SPEED_SERIAL) $(USER_CFLAGS)
